...
function Testimonial() {
  const testimonials = [
    ...
    },
    {
      ...
      title: "Marketing Head at DEF Inc.",
      image: userImg,
      text: "Feverything is going good so far , logo is done , cant wait to see the format that will be on google , jack got the logo on the first try ,, !!!!!!!!!",
      rating: 5,
      date: "September 3, 2025",
    },
        {
      ...
      name: "Dahnyell",
      title: "Marketing Head at DEF Inc.",
      image: "https://i1.rgstatic.net/ii/profile.image/789504524840969-1565243955980_Q512/Alvin-Chua-6.jpg",
      text: "The quick turnaround exceeded my expectations. They gave me what I wanted with the colors I asked for. I appreciate them",
      rating: 5,
      date: "September 3, 2025",
    },
        {
      id: 6,
      name: "William Sherrill",
      title: "Marketing Head at DEF Inc.",
      image: "https://img.freepik.com/premium-photo/handsome-european-male-model-with-red-hair-beard-turn-head-looking-pleased-copy-space-left-side-standing-pink-background_1258-48832.jpg?semt=ais_hybrid&w=740&q=80",
      text: "Jack did a great job. I was kind of picky and they pulled through for me made exactly what I wanted and we’re super helpful. Looking forward to getting my shirts.",
      rating: 5,
      date: "September 3, 2025",
    },
  ];
